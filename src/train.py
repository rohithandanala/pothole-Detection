...
def train_and_predict (config_path:str = 'configs'):
    ...
    Raw_images_list = data_loader.loadData('data/Raw')
    ...
    os.system(f"python yolov5/train.py --img 640 --batch {data_configs['n_batch']} --epochs {data_configs['n_epochs']} --data configs/data.yaml --weights yolov5s.pt --name pothole_yolov5s") #Adjust the attributes accordingly here.
